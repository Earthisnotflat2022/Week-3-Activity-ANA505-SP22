...
women_wt = women_ht_wt["weight"]
women_ht = women_ht_wt["height"]
...
women_df <- tibble(women_ht, women_wt)
print(women_df)
...
women_ht_65up <- filter(.data = women_ht_wt, height >= 65)
print(x = women_ht_65up)
...
ggplot(women_ht_wt, aes(x=height, y=weight)) + 
  geom_point()
